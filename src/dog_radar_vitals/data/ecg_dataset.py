"""レーダI/Q窓とECG波形窓を束ねるPyTorch Dataset。"""
...
from dog_radar_vitals.data.ecg_windowing import iter_windows
...
class ECGWindowDataset(Dataset):
    def __init__(
        ...
        for subject_id in subject_ids:
            ...
            self._samples.extend(iter_windows(rec, window_sec, stride_sec))
